  ...
  <div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl lg:mx-0">
        <h2 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">My Hobby And My Skill</h2>
        <p class="mt-6 text-lg leading-8 text-gray-300">My hobbies are playing games and business. Why do I like business? yapss because I like money.
            My business is selling meatballs but that's just a hobby, because I'm busy going to school now. Then I'm also busy, not just studying, but I'm busy because I'm doing field work practice at school or called (PKL) in Indonesian.
        </p>
...
const links = [
  ...
  { name: 'Play Great Games', },
  { name: 'UI & UX'},
  { name: 'Vue.js', },
]
const stats = [
  { name: 'Developers', value: '73M+' },
  { name: 'Projects', value: '3+' },
  { name: 'Open source projects', value: '1000s' },
